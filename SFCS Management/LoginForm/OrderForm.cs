    ...
    public partial class OrderForm : Form
    {
        ...
        private void viewOrderList()
        {
            ...
            for (i = 0; i < dt.Rows.Count; ++i)
            {
                ...
                lbPrice.Text = row["totalPrice"].ToString() + " VND";
        ...
        private void viewOrderDetails(String orderID)
        {
            ...
            pnlOrder.Controls.Add(btnBack);
            pnlOrder.Controls.Add(lbID);
            ...
            pnlOrder.Controls.Add(pnlIOrderLine);
            ...
            for (i = 0; i < dt.Rows.Count; ++i)
            {
                ...
                pnlOrder.Controls.Add(pnlOrderLine);
